...
def _scroll_to_end(wd, sleep_between_interactions):
...
&tbm=isch&source=hp&q={q}&oq={q}&gs_l=img"""
    ...
    while image_count < max_links_to_fetch:
        ...
        print(
            f"""Found: {number_results} search results.
Extracting links from {results_start}:{number_results}"""
        )
