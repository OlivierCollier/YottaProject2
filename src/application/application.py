...
st.write(
 ...
 essaiera de deviner la ville dont la photo provient (Parmi les villes de Paris,
 Amsterdam, Strasbourg, Londres et Venise) !"""
)
image_data = st.file_uploader(
    "Veuillez insérer une image afin de commencer la prédiction :",
    type=["jpg", "jpeg", "png"],
)
